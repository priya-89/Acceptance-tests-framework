...
public class SeleniumBase extends Matchers {
    ...
    ObjectLib obj = new ObjectLib("C:/Periscopix_AcceptanceTests/Peris_GA_Java_Cucumber_Maven_Auto/src/test/java/step_definitions/support/OR.properties");
    ...
    public void radio(String Object, String Value) {
        try {
